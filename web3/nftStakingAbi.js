export const nftStakingAbi = [
  ...
  { inputs: [], name: "Unapprovable", type: "error" },
  { inputs: [], name: "Untransferable", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
  ...
  },
  {
    ...
    name: "staked",
    outputs: [{ internalType: "uint256", name: "claimedAt", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  {
